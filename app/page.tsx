...
const COPY = {
  es: {
    ...
    training:"TRAINING",trainingTitle:"Construye una jugada posible.",trainingText:"Ajusta potencia, dirección, altura, inclinación y distancia. El laboratorio calcula la trayectoria y colorea cada contacto."
  },
  pt: {
    ...
    training:"TRAINING",trainingTitle:"Construa um lance possível.",trainingText:"Ajuste potência, direção, altura, inclinação e distância. O laboratório calcula a trajetória e colore cada contato."
  }
};
