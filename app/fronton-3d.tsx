...
const LABELS = {
  es:{title:"Cancha 3D interactiva",help:"Arrastra para girar la cámara. El valor especial depende de dónde el jugador golpea.",video:"Jugada 30–35 s",videoHits:"FINAL · 30–35 S",estimated:"RECONSTRUCCIÓN ESTIMADA",firstBounce:"1.er PIQUE",secondBounce:"2.º PIQUE",missed:"NO LLEGÓ",almostLata:"CASI TOCA LA LATA",adversary:"ADVERSARIO",lata:"Lata",two:"Especial · 2",three:"Especial · 3",suncho:"Suncho",play:"Reproducir",replay:"Repetir",against:"PUNTO EN CONTRA",points:"PUNTOS",impact:"CONTACTO",strike:"GOLPE DEL JUGADOR",near:"ZONA 2",far:"ZONA 3",frontis:"FRONTIS",metal:"SONIDO METÁLICO"},
  pt:{title:"Quadra 3D interativa",help:"Arraste para girar a câmera. O valor especial depende de onde o jogador rebate.",video:"Lance 30–35 s",videoHits:"FINAL · 30–35 S",estimated:"RECONSTRUÇÃO ESTIMADA",firstBounce:"1.º QUIQUE",secondBounce:"2.º QUIQUE",missed:"NÃO ALCANÇOU",almostLata:"QUASE NA LATA",adversary:"ADVERSÁRIO",lata:"Lata",two:"Especial · 2",three:"Especial · 3",suncho:"Suncho",play:"Reproduzir",replay:"Repetir",against:"PONTO CONTRA",points:"PONTOS",impact:"CONTATO",strike:"REBATIDA DO JOGADOR",near:"ZONA 2",far:"ZONA 3",frontis:"FRONTIS",metal:"SOM METÁLICO"},
};
...
function drawScene(x:CanvasRenderingContext2D,width:number,height:number,yaw:number,scenario:Scenario,shot:(typeof SCENARIOS)[ScoringScenario],time:number,copy:(typeof LABELS)[Lang]){
  ...
  const target:V3=[0,lerp(2.25,.48,zoom),lerp(8,.35,zoom)],radius=lerp(24,8.2,zoom);
...
function drawVideoRally(x:CanvasRenderingContext2D,project:(v:V3)=>{x:number;y:number;scale:number}|null,time:number,copy:(typeof LABELS)[Lang]){
  label(x,project,[0,6.25,.03],`${copy.estimated} · 00:30 → 00:35`,"#c9ff36");
