...
function addOverSector(scene:THREE.Scene){const color=0xff496c,angle=Math.atan2(12,20),length=Math.hypot(20,12);scene.add(box(5,.05,.09,color,[0,11.975,.045]),box(5,.05,.05,color,[0,.025,24.975]));for(const x of [-2.5,2.5]){scene.add(box(.09,.05,5,color,[x,11.975,2.5]));const diagonal=box(.09,.05,length,color,[x,6,15]);diagonal.rotation.x=angle;scene.add(diagonal)}}
